...
import { OtoqModel } from './otoq.model';

export class OtoqParam extends QueryParams {
    ...
    constructor(public attrs: any = null) {
        ...
        this.modelName = OtoqModel.ModelName;
    }
    ...
    initQp() {
        ...
        this.questionClassIdx = this.questionClassIdx || Cd.All;
        this.joinType = this.joinType || Cd.All;
        this.deletedFlag = this.deletedFlag || Cd.All;
        this.answerDoneFlag = this.answerDoneFlag || Cd.All;
    ...
    clearQp() {
        ...
        this.questionClassIdx = Cd.All;
        this.joinType = Cd.All;
        this.deletedFlag = Cd.All;
        this.answerDoneFlag = Cd.All;
        this.setMinMaxDate();
    }
