...
export class NoticeParam extends QueryParams {
    ...
    constructor(public attrs: any = null) {
        ...
        this.postType = this.postType || Cd.PostType.notice;
        this.deletedFlag = this.deletedFlag || Cd.YN.N;
        this.order_desc = this.order_desc || 'createdTs';
    }
